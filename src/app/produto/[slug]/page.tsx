          ...
          <div className="flex flex-col items-center gap-3 pt-6 mt-6 border-t border-[#E0E0E0]">
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="flex items-center justify-center w-11 h-11 rounded-full bg-[#F5F5F5] text-[#2D2D2D] hover:bg-[#2D2D2D] hover:text-white transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#6B8E7A] focus-visible:outline-offset-2"
