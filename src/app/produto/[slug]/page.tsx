    ...
    <main className="min-h-screen pb-24 md:pb-8">
      ...
      <div className="container mx-auto px-4 py-4 md:py-8">
        ...
        <section className="mt-10 p-6 bg-[var(--color-cream)] rounded-lg">
          ...
          {/* Redes Sociais */}
          <div className="flex flex-col items-center gap-3 pt-6 mt-6 border-t border-[#E0E0E0]">
            <p className="text-sm font-medium text-[#4A4A4A] m-0">Siga a Moveirama</p>
            <div className="flex gap-4">
              <a 
                href="https://www.facebook.com/moveirama" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center justify-center w-11 h-11 rounded-full bg-[#F5F5F5] hover:bg-[#2D2D2D] transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#6B8E7A] focus-visible:outline-offset-2 group"
                aria-label="Facebook da Moveirama"
              >
                <svg className="w-5 h-5 fill-[#2D2D2D] group-hover:fill-white transition-colors" viewBox="0 0 24 24" aria-hidden="true">
