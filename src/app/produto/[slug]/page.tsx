  ...
  return (
    <main className="min-h-screen pb-24 md:pb-8">
      ...
      <div className="product-container">
        ...
        {/* Seção: Redes Sociais */}
        <section className="mt-10 py-12 md:py-16 bg-[#FBF9F7] rounded-lg text-center">
          <div className="max-w-[600px] mx-auto px-4">
            <h2 className="text-2xl md:text-[28px] font-semibold text-[#2D2D2D] mb-2">
            ...
            <div className="flex justify-center gap-8 md:gap-12">
              ...
              <a 
                ...
                className="flex flex-col items-center gap-3 group focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#6B8E7A] focus-visible:outline-offset-4 rounded-lg"
                aria-label="Facebook da Moveirama"
              >
                <span className="flex items-center justify-center w-16 h-16 rounded-2xl bg-white border-2 border-[#E0E0E0] group-hover:bg-[#2D2D2D] group-hover:border-[#2D2D2D] group-hover:-translate-y-1 transition-all">
                  <svg className="w-7 h-7 fill-[#2D2D2D] group-hover:fill-white transition-colors" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </span>
                <span className="text-sm font-medium text-[#2D2D2D] group-hover:text-[#6B8E7A] transition-colors">
                  Facebook
                </span>
              </a>
