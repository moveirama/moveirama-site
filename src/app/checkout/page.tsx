 ...
 * Versão: 2.2 (Removido Mini-Summary, acordeão no SummaryCard)
 * Data: 29 Janeiro 2026
 * 
 * CHANGELOG v2.2:
 * - Removido CheckoutMiniSummary (acordeão no SummaryCard faz o papel)
 * - Removido summaryCardRef (não precisa mais do IntersectionObserver)
...
export default function CheckoutPage() {
  ...
  return (
    <CheckoutLayout
      ...
      sidebar={<CheckoutSummaryCard {...sidebarData} />}
    >
      {/* Voltar */}
      <Link 
        href="/carrinho"
